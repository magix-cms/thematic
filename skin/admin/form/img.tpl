<div class="row">
    ...
    <form id="add_img_thematic" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&amp;edit={$smarty.get.edit}" method="post" enctype="multipart/form-data" class="form-gen col-ph-12">
