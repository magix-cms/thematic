...
<div class="row">
    <form id="edit_thematic" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$page.id_tc}&amp;tabs=pages" method="post" class="validate_form edit_form_extend col-ph-12 col-lg-8">
